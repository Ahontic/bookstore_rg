...
RSpec.describe BookSorter do
  ...
  let(:book2) do
    create(:book, title: 'Adam', price: 20,
                  created_at: Time.zone.today - 2, category: category, material: material)
  end
  let(:book3) do
    create(:book, title: 'Bob', price: 10,
                  created_at: Time.zone.today, category: category, material: material)
  end
  let(:book4) do
    create(:book, title: 'Clark', price: 30,
                  created_at: Time.zone.today - 1, category: category, material: material)
  end
